...
export function AmountDisplay({ amount }: AmountDisplayProps) {
  ...
  return (
    <View className="items-center justify-center min-h-[154px] px-6">
      <Text className="text-foreground-tertiary text-[11px] font-bold tracking-[1.1px] mb-2">AMOUNT</Text>
      <Text adjustsFontSizeToFit numberOfLines={1} className="text-foreground text-[54px] font-bold tracking-[-2px]" testID="AmountDisplay">
        {formatted}
      </Text>
    </View>
  );
