...
export function buildInitialState(
  ...
  if (editingRule) {
    ...
    return {
      ...
      splitCategoryIds: editingRule.lines.length > 1 ? editingRule.lines.map(l => l.categoryId) : [],
  ...
  if (editingTx) {
    ...
    return {
      ...
      splitCategoryIds: editingTx.lines.length > 1 ? editingTx.lines.map(l => l.categoryId) : [],
